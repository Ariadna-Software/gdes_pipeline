...
var actualizarMensajeOfertaDb = function (ofertas, done) {
    ...
    async.eachSeries(ofertas, function (oferta, callback) {
        ...
        if (oferta.oferta.pedido) {
            ...
            oferta.ofertaDb.pedido = oferta.oferta.pedido;
        } else {
            msg += " PEDIDO:" + fnPonerEnRojo('VACIO');
            oferta.ofertaDb.pedido = null;
        }
        // importe
        ...
        if (oferta.oferta.importeAnoActual) {
            ...
            oferta.ofertaDb.importeAnoActual = oferta.oferta.importeAnoActual;
        } else {
            msg += " IMPORTE AÑO ACT:" + fnPonerEnRojo('VACIO');
            oferta.ofertaDb.importeAnoActual = null;
        }
        // margen
...
var fnVerificarFechaCorrecta = function (vfecha) {
    ...
    if (!moment(vfecha, 'DD/MM/YYYY').valid()) return "";
    return moment(vfecha, 'DD/MM/YYYY').format("YYYY-MM-DD");
}
