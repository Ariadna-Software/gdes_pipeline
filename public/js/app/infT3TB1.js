...
var apiInfT3TB1 = {
    ...
    obtainJSON: function () {
        var url = "/pwbi/T3TB1?fase=" + fase + "&pais=" + pais + "&dFecha=" + dFecha + "&hFecha=" + hFecha + "&estado=" + estado;
        apiComunAjax.llamadaGeneral("GET", myconfig.apiUrl + url, data, function (err, data) {
            if (err) return;
            apiInfT3TB1.obtainReport(data);
        });
    },
    obtainReport: function (data) {
        ...
        // var sql2 = apiInfT3TB1.processParameters(sql);
        // report.dataSources.items[0].sqlCommand = sql2;

        var dataSet = new Stimulsoft.System.Data.DataSet("T3TB1");
