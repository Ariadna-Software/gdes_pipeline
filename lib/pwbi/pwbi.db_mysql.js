...
var pwbiDbAPI = {
    ...
    getT1TB1: function (fase, pais, dFecha, hFecha, estado, done) {
        comun.getConnectionCallback(function (err, con) {
            ...
            sql += " LEFT JOIN areas AS a ON a.areaId = o.areaId";git 
    ...
    getT5TB1: function (area, pais, dFecha, hFecha, done) {
        comun.getConnectionCallback(function (err, con) {
            ...
            sql += " WHERE (o.tipoOportunidadId <> 1 OR o.tipoOportunidadId IS NULL) AND o.faseOfertaId = 0"; // (FORZADO)
